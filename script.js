function y1894() {
    ...
    document.getElementById('response-date').innerText = 'December 22, 1937'
}

function y1991() {
    document.getElementById('changeImage').src = 'images'
    ...
    document.getElementById('response-date').innerText = 'December 22, 1991'
}
function y2022() {
    document.getElementById('changeImage').src = 'images'
    ...
    document.getElementById('response-date').innerText = 'December 22, 2022'
}
function y1894() {
    document.getElementById('changeImage').src = 'images'
    ...
    document.getElementById('response-date').innerText = 'December 22, 1894'
}
function y2010() {
    document.getElementById('changeImage').src = 'images'
    ...
    document.getElementById('response-date').innerText = 'December 22, 2010'
}

function y2006() {
    document.getElementById('changeImage').src = 'images'
    document.getElementById('response-text').innerText = 'Ay dats me!!'
    document.getElementById('response-date').innerText = 'December 22, 2006'
}
